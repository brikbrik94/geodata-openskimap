...
KNOWN_SOURCE_LAYERS = {
    ...
    "ski_runs_sled_line",
    "ski_runs_sled_poly",
    "ski_runs_connection_line",
    "ski_runs_snow_park_line",
    "ski_runs_snow_park_poly",
    "ski_runs_playground_line",
    "ski_runs_playground_poly",
    "ski_runs_ice_skate_line",
    "ski_runs_ice_skate_poly",
    "ski_lifts",
    "ski_spots",
}
